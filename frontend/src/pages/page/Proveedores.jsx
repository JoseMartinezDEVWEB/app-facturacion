...
const Proveedores = () => {
  ...
  const fetchSupplierTransactions = async (supplierId) => {
    try {
      const response = await axios.get(`${API_URL}/suppliers/${supplierId}/transactions`);
  ...
  const handleAddTransaction = async () => {
    ...
    try {
      ...
      await axios.post(`${API_URL}/suppliers/${currentSupplier._id}/transactions`, transactionData);
      
      // Actualizar el listado de transacciones
      fetchSupplierTransactions(currentSupplier._id);
      
      // Actualizar estadísticas y listado de proveedores
      fetchSuppliers();
      fetchStats();
